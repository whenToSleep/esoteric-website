      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 lg:grid-cols-3 lg:gap-8">
          ...
          <Link
            ...
            className="group md:col-span-2 overflow-hidden rounded-2xl border border-cosmic-purple/15 bg-cosmic-card hover:border-cosmic-violet/40 transition-colors duration-300"
          >
