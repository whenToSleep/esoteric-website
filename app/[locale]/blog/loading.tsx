    ...
    <section className="px-4 py-12 md:py-16 lg:py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mb-8 flex justify-center">
          <div className="h-10 w-48 animate-pulse rounded-lg bg-onyx md:h-12 md:w-64" />
        </div>
        ...
        <div className="mb-8 flex justify-center gap-3">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="h-9 w-24 animate-pulse rounded-full bg-onyx"
        ...
        <div className="mb-8 animate-pulse overflow-hidden rounded-3xl border border-overlay/50 bg-onyx">
          <div className="flex flex-col md:flex-row">
            <div className="aspect-video w-full bg-elevated md:aspect-auto md:w-1/2" />
